...
class User(Base):
    ...
    profile_image_url: str = Column(
        String, nullable=False, comment="profile_image_url", default=""
    )
...
class UserDto:
    class Base(CustomPydanticBaseModel):
        ...
        created_at: datetime = Field(
            default=None, title="created_at", description="created_at"
        )
        updated_at: datetime = Field(
            default=None, title="updated_at", description="updated_at"
        )
        ...
        profile_image_url: str = Field(
            default=None, title="profile_image_url", description="profile_image_url"
        )
        user_token: str = Field(
            default=None, title="user_token", description="user_token"
        )
        is_active: bool = Field(
            default=None, title="is_active", description="is_active"
        )
        is_superuser: bool = Field(
            default=None, title="is_superuser", description="is_superuser"
        )
        is_verified: bool = Field(
            default=None, title="is_verified", description="is_verified"
        )
        is_deleted: bool = Field(
            default=None, title="is_deleted", description="is_deleted"
        )
        visited_at: datetime = Field(
            default=None, title="last_login_at", description="last_login_at"
        )
    ...
    class ListResponse(ListResponseDto):
        results: list["UserDto.WithModelBaseInfo"] = Field(
            default=None, title="items", description="items"
        )
...
class UserBaseInfoDto(BaseModel):
    ...
    profile_image_url: str = Field(
        ..., title="profile_image_url", description="profile_image_url"
    )
...
class AuthDto:
    ...
    class JWTPayload(BaseModel):
        ...
        refresh_token: str = Field(
            ..., title="refresh_token", description="refresh_token"
        )
